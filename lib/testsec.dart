...
import 'package:backend/woowool/FirstTest.dart';


class WooWool extends StatelessWidget {
  const WooWool({Key? key});
        ...
        child: Column(
          children: [
            ...
            Container(
              ...
              child: Text(
                '우울감과 관련한 인지적, 정서적, 신체적 증상에 대한 검사입니다. * 결과는 자기보고 형식으로 측정되며, 정신과적 진단을 의미하는 것은 아닙니다.',
                style: TextStyle(
                  fontSize: 18,
                ),
              ),
